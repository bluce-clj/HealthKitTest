        ...
        if let healthStore = self.healthStore {
            ...
            let readList: Set<HKSampleType> =
                [
                    ...
                    //
                    //                    HKQuantityType.correlationType(forIdentifier: HKCorrelationTypeIdentifier.bloodPressure)!,
                    //                    HKQuantityType.correlationType(forIdentifier: HKCorrelationTypeIdentifier.food)!
                ]

            healthStore.requestAuthorization(toShare: readList, read: readList, completion: { (state, error) in
                if state {
                    print("success")
                } else {
                    print("fail")
